...
<?php get_sidebar(); ?>
            ...
            <div id="content">
                ...
                //$event = $EM_Event->id;
                //if( $booking != "" ) {                    
                //    $wpdb->insert("wp_em_bookings", array(
                //                    "event_id" => $event,
                //                    "person_id" => $person,
                //                    "booking_spaces" => 1,
                //                    "booking_comment" => $comment,
                //                    "booking_date" => date("2011-09-14 10:41:09"),
                //                    "booking_price" => 0.00,
                //                    "booking_meta" => "a:0:{}"
                //                  ));
                //}
                //
                //$dbQuery = "select * from wp_em_bookings where event_id=".$event." and person_id=".$person;
                ////echo $dbQuery;
                //$booked = $wpdb->query($dbQuery) >= 1 ? true : false;
                $person = get_current_user_id();
